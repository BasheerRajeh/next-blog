...
const DangerArea = () => {
    ...
    const handleDeleteMyAccount = async (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault()
        ...
        <div className='rounded-lg border border-red-500/50 bg-zinc-900/60'>
            <div className='p-4'>
                ...
                <p className='mb-4 text-sm'>
                    This action will permanently remove all your posts, data,
                    and personal information associated with your account. This
